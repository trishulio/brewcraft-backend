...
CREATE SEQUENCE BREW_TASK_SEQUENCE START 1;
...
CREATE SEQUENCE BREW_STAGE_STATUS_SEQUENCE START 1;
...
INSERT INTO BREW_STAGE_STATUS VALUES (4, 'SPLIT');
...
CREATE TABLE BREW_LOG_TYPE (
    ID INTEGER PRIMARY KEY,
	NAME VARCHAR(255) NOT NULL
);
CREATE SEQUENCE BREW_LOG_TYPE_SEQUENCE START 1;
INSERT INTO BREW_LOG_TYPE VALUES (1, 'ADD_MATERIAL');
INSERT INTO BREW_LOG_TYPE VALUES (2, 'RECORD_MEASURE');
INSERT INTO BREW_LOG_TYPE VALUES (3, 'RECORD_WASTE');
INSERT INTO BREW_LOG_TYPE VALUES (4, 'TRANSFER');

CREATE TABLE BREW_LOG (
    ID INTEGER PRIMARY KEY,
	BREW_STAGE_ID INTEGER NOT NULL REFERENCES BREW_STAGE(ID),
	RECORDED_AT TIMESTAMP NOT NULL,
	COMMENT VARCHAR(255),
	BREW_LOG_TYPE_ID INTEGER NOT NULL REFERENCES BREW_LOG_TYPE(ID),
    CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    LAST_UPDATED TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    VERSION INTEGER
);
CREATE SEQUENCE BREW_LOG_SEQUENCE START 1;

CREATE TABLE BREW_MEASURE_VALUE (
    ID INTEGER PRIMARY KEY,
	BREW_LOG_ID INTEGER NOT NULL REFERENCES BREW_LOG(ID),
	BREW_MEASURE_NAME VARCHAR(255) NOT NULL REFERENCES PRODUCT_MEASURE(NAME),
	BREW_MEASURE_VALUE VARCHAR(255) NOT NULL
);
CREATE SEQUENCE BREW_MEASURE_VALUE_SEQUENCE START 1;
