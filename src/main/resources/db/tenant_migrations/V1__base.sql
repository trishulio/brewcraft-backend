...
CREATE SEQUENCE PURCHASE_ORDER_SEQUENCE START 2;
...
INSERT INTO PRODUCT_MEASURE VALUES 
	...
	(8, 'fermentationDays'),
	(9, 'conditioningDays');
CREATE SEQUENCE PRODUCT_MEASURE_SEQUENCE START 10;
...
CREATE TABLE PRODUCT_MEASURE_VALUE (
	...
	PRODUCT_MEASURE_ID INTEGER NOT NULL REFERENCES PRODUCT_MEASURE(ID),
	PRODUCT_MEASURE_VALUE VARCHAR(255) NOT NULL,
	UNIQUE (PRODUCT_ID, PRODUCT_MEASURE_ID)
);
...
CREATE TABLE MIXTURE_RECORDING (
	...
	MEASURE_ID VARCHAR(255) NOT NULL REFERENCES PRODUCT_MEASURE(ID),
