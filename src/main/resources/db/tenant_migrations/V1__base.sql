...
CREATE TABLE INVOICE (
    ...
    FREIGHT_CURRENCY_ID INTEGER REFERENCES CURRENCY(NUMERIC_CODE) NOT NULL,
    FREIGHT_VALUE NUMERIC(20, 4) NOT NULL,
...
CREATE TABLE INVOICE_ITEM (
    ...
    QTY_UNIT_SYMBOL VARCHAR(4) REFERENCES QTY_UNIT(SYMBOL) NOT NULL,
    QTY_VALUE NUMERIC(20, 4) NOT NULL,
    PRICE_ID INTEGER REFERENCES MONEY(ID),
    PRICE_CURRENCY_ID INTEGER REFERENCES CURRENCY(NUMERIC_CODE) NOT NULL,
    PRICE_VALUE NUMERIC(20, 4) NOT NULL,
    TAX_CURRENCY_ID INTEGER REFERENCES CURRENCY(NUMERIC_CODE) NOT NULL,
    TAX_VALUE NUMERIC(20, 4) NOT NULL,
