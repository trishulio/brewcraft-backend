...
public class EnhancedBrewRepositoryImpl implements EnhancedBrewRepository {
    ...
    public EnhancedBrewRepositoryImpl(ProductRepository productRepository, BrewRepository brewRepository, AccessorRefresher<Long, ParentBrewAccessor, Brew> refresher) {
