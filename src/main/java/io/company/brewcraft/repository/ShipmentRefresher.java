...
public class ShipmentRefresher implements EnhancedShipmentRepository {
    ...
    @Autowired
    public ShipmentRefresher(AccessorRefresher<Long, ShipmentAccessor, Shipment> refresher, ShipmentStatusRepository shipmentStatusRepo, MaterialLotRepository materialLotRepo) {
