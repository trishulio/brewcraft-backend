...
public class ShipmentService extends BaseService implements CrudService<Long, Shipment, BaseShipment<? extends BaseMaterialLot<?>>, UpdateShipment<? extends UpdateMaterialLot<?>>, ShipmentAccessor> {
    ...
    public Page<Shipment> getShipments(
        ...
        final Specification<Shipment> spec= WhereClauseBuilder.builder()
                                                          ...
                                                          // invoice filters
                                                          .in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_ID}, invoiceIds)
                                                          .not().in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_ID}, invoiceExcludeIds)
                                                          .in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_INVOICE_NUMBER}, invoiceNumbers)
                                                          .in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_DESCRITION}, invoiceDescriptions)
                                                          .in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_DESCRIPTION}, invoiceItemDescriptions)
                                                          .between(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_GENERATED_ON}, generatedOnFrom, generatedOnTo)
                                                          .between(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_RECEIVED_ON}, receivedOnFrom, receivedOnTo)
                                                          .between(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_PAYMENT_DUE_DATE}, paymentDueDateFrom, paymentDueDateTo)
                                                          .in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_PURCHASE_ORDER, PurchaseOrder.FIELD_ID}, purchaseOrderIds)
                                                          .in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_MATERIAL}, materialIds)
                                                          .between(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_AMOUNT, MoneyEntity.FIELD_AMOUNT }, amtFrom, amtTo)
                                                          .between(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_FREIGHT, Freight.FIELD_AMOUNT, MoneyEntity.FIELD_AMOUNT }, freightAmtFrom, freightAmtTo)
                                                          .in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_INVOICE_STATUS, InvoiceStatus.FIELD_ID}, invoiceStatusIds)
                                                          .in(new String[] { Shipment.FIELD_LOTS, MaterialLot.FIELD_INVOICE_ITEM, InvoiceItem.FIELD_INVOICE, Invoice.FIELD_PURCHASE_ORDER, PurchaseOrder.FIELD_SUPPLIER, Supplier.FIELD_ID}, supplierIds)
                                                          .build();
