...
public interface FinishedGoodInventoryService {
    ...
    Page<FinishedGoodInventory> getAll(Set<Long> ids, Set<Long> excludeIds, Set<Long> skuIds, Set<Long> mixtureIds, Set<Long> brewStageIds, Set<Long> brewIds, Set<String> brewBatchIds, Set<Long> productIds, SortedSet<String> sort, boolean orderAscending, int page, int size);
