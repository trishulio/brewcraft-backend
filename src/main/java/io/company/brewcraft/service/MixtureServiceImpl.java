...
public class MixtureServiceImpl extends BaseService implements MixtureService {
	...
	public Page<Mixture> getMixtures(Set<Long> ids, Set<Long> parentMixtureIds, Set<Long> equipmentIds,
			...
			Set<Long> productIds, int page, int size, Set<String> sort, boolean orderAscending) {
	...
	@Override
	public Mixture putMixture(Long mixtureId, Mixture putMixture, BrewLog brewLog) {
        ...
        if (existingMixture == null) {
            ...
            existingMixture.override(putMixture, getPropertyNames(BaseProduct.class));       
	...
	@Override
	public Mixture patchMixture(Long mixtureId, Mixture patchMixture, BrewLog brewLog) {
