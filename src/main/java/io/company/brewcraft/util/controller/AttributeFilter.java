...
public class AttributeFilter {
    ...
    public void retain(Object o, Set<String> attributes) {
        setNullValueOnProps(o, attributes, propName -> !attributes.contains(propName));
    }
    ...
    private void setNullValueOnProps(Object o, Set<String> attributes, Function<String, Boolean> predicate) {
        try {
