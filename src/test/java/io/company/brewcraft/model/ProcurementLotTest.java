...
public class ProcurementLotTest {
    ...
    public void testAllArgConstructor() {
        lot = new ProcurementLot(1L, "LOT_NUMBER", Quantities.getQuantity(new BigDecimal("10"), SupportedUnits.GRAM), new Material(1L), new Shipment(2L), new InvoiceItem(3L), new Storage(4L));
    ...
    public void testAllArgJpaConstructor() {
        lot = new ProcurementLot(1L, "LOT_NUMBER", new Material(1L), "MATERIAL_NAME", new InvoiceItem(3L), new Shipment(2L), new Storage(4L), new UnitEntity("g"), new BigDecimal("10"));
        assertEquals(1L, this.lot.getId());
        assertEquals("LOT_NUMBER", this.lot.getLotNumber());
    ...
    public void testLotQuantityConstructor() {
        this.lot = new ProcurementLot("LOT_1", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotInvoiceItemQuantityConstructor() {
        this.lot = new ProcurementLot("LOT_1", new InvoiceItem(1L), new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testShipmentQuantityConstructor() {
        ...
        this.lot = new ProcurementLot(shipment, new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testShipmentInvoiceItemQuantityConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot(shipment, new InvoiceItem(1L), new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testMaterialQuantityConstructo() {
        this.lot = new ProcurementLot(new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testMaterialInvoiceItemQuantityConstructo() {
        this.lot = new ProcurementLot(new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testStorageQuantityConstructor() {
        this.lot = new ProcurementLot(new Storage(1L), new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testStorageInvoiceItemQuantityConstructor() {
        this.lot = new ProcurementLot(new Storage(1L), new InvoiceItem(1L), new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testInvoiceItemQuantityConstructor() {
        this.lot = new ProcurementLot(new InvoiceItem(1L), new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotMaterialQtyConstructor() {
        this.lot = new ProcurementLot("LOT_1", new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotMaterialInvoiceItemQtyConstructor() {
        this.lot = new ProcurementLot("LOT_1", new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testShipmentMaterialQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot(shipment, new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testShipmentMaterialInvoiceItemQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot(shipment, new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testStorageMaterialQtyConstructor() {
        this.lot = new ProcurementLot(new Storage(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testStorageMaterialInvoiceItemQtyConstructor() {
        this.lot = new ProcurementLot(new Storage(1L), new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotShipmentMaterialQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot("LOT_1", shipment, new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotShipmentInvoiceItemQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot("LOT_1", shipment, new InvoiceItem(10L), new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotShipmentMaterialInvoiceItemQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot("LOT_1", shipment, new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotShipmentStorageMaterialQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot("LOT_1", shipment, new Storage(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotShipmentStorageInvoiceItemQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot("LOT_1", shipment, new Storage(1L), new InvoiceItem(10L), new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testLotShipmentStorageMaterialInvoiceItemQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new ProcurementLot("LOT_1", shipment, new Storage(1L), new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("g", "gram"), new BigDecimal("10"));
    ...
    public void testToString_ReturnsJsonifiedString() throws JSONException {
        this.lot = new ProcurementLot(1L, "LOT_1", Quantities.getQuantity(new BigDecimal("10"), SupportedUnits.GRAM), new Material(3L), new Shipment(1L), new InvoiceItem(4L), new Storage(2L));
