...
public class StockLotTest {
    ...
    public void testAllArgConstructor() {
        lot = new StockLot(1L, "LOT_NUMBER", Quantities.getQuantity(new BigDecimal("10"), Units.KILOGRAM), new Material(1L), new Shipment(2L), new InvoiceItem(3L), new Storage(4L));
    ...
    public void testAllArgJpaConstructor() {
        lot = new StockLot(1L, "LOT_NUMBER", new Material(1L), "MATERIAL_NAME", new InvoiceItem(3L), new Shipment(2L), new Storage(4L), new UnitEntity("kg"), new BigDecimal("10"));
        assertEquals(1L, this.lot.getId());
        assertEquals("LOT_NUMBER", this.lot.getLotNumber());
        assertEquals(Quantities.getQuantity(new BigDecimal("10"), Units.KILOGRAM), this.lot.getQuantity());
        assertEquals(new Material(1L), this.lot.getMaterial());
    ...
    public void testLotInvoiceItemQuantityConstructor() {
        this.lot = new StockLot("LOT_1", new InvoiceItem(1L), new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testShipmentInvoiceItemQuantityConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new StockLot(shipment, new InvoiceItem(1L), new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testMaterialInvoiceItemQuantityConstructo() {
        this.lot = new StockLot(new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testStorageInvoiceItemQuantityConstructor() {
        this.lot = new StockLot(new Storage(1L), new InvoiceItem(1L), new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testInvoiceItemQuantityConstructor() {
        this.lot = new StockLot(new InvoiceItem(1L), new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testLotMaterialInvoiceItemQtyConstructor() {
        this.lot = new StockLot("LOT_1", new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testShipmentMaterialInvoiceItemQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new StockLot(shipment, new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testStorageMaterialInvoiceItemQtyConstructor() {
        this.lot = new StockLot(new Storage(1L), new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testLotShipmentMaterialInvoiceItemQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new StockLot("LOT_1", shipment, new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
    ...
    public void testLotShipmentStorageMaterialInvoiceItemQtyConstructor() {
        final Shipment shipment = new Shipment(1L);
        this.lot = new StockLot("LOT_1", shipment, new Storage(1L), new InvoiceItem(1L), new Material(1L), "UNUSED_MATERIAL_NAME", new UnitEntity("kg", "Kilogram"), new BigDecimal("10"));
