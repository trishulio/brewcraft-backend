...
public class FinishedGoodInventoryControllerTest {
   ...
   public void testGetAll_CallsServicesWithArguments_AndReturnsPageDtoOfFinishedGoodIventoryDtosMappedFromFinishedGoodInventoryPage() {
       ...
       assertEquals(List.of(new MixturePortionDto(6L, new MixtureDto(8L), new QuantityDto("g", BigDecimal.valueOf(4)), 1)), finishedGoodInventory.getMixturePortions());
       assertEquals(List.of(new MaterialPortionDto(7L, new MaterialLotDto(8L), new QuantityDto("g", BigDecimal.valueOf(5)), LocalDateTime.of(1999, 1, 1, 1, 1), 1)), finishedGoodInventory.getMaterialPortions());
