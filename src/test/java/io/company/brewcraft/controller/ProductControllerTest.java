...
public class ProductControllerTest {
   ...
   public void testGetProducts() {
       ...
       Product product = new Product(1L, "testProduct", "testDescription", style, targetMeasures, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), null, 1);
   ...
   public void testGetProduct() {
       ...
       Product product = new Product(1L, "testProduct", "testDescription", style, targetMeasures, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
   ...
   public void testAddProduct() {
       ...
       AddProductDto addProductDto = new AddProductDto("testProduct", "testDescription", 2L, targetMeasuresDto, "http://www.test.com");
   ...
   public void testPutProduct() {
       List<AddProductMeasureValueDto> targetMeasuresDto = List.of(new AddProductMeasureValueDto(1L, new BigDecimal("100")));
       UpdateProductDto updateProductDto = new UpdateProductDto("testProduct", "testDescription", 2L, targetMeasuresDto, "http://www.test.com", 1);
