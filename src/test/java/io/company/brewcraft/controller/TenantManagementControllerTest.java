...
public class TenantManagementControllerTest {
    ...
    public void testGetAll_ReturnsListOfAllTenants() throws Exception {
       TenantDto tenant1 = new TenantDto(UUID.fromString("b3c97f3f-dd2d-42d0-9032-954f361de632"), "testName", "testUrl", LocalDateTime.of(2020, 1, 2, 3, 4));
       TenantDto tenant2 = new TenantDto(UUID.fromString("33581762-ff4b-494f-bc40-c66216e2b420"), "testName2", "testUrl2", LocalDateTime.of(2021, 2, 3, 4, 5));
       ...
       this.mockMvc.perform(get("/operations/tenants"))
    ...
    public void testAddTenant_ReturnsNewTenantId() throws Exception {
        ...
        verify(tenantManagementServiceMock, times(1)).addTenant(any());
    }

    @Test
    public void testGetTenant_ReturnsTenant() throws Exception {
        TenantDto tenant = new TenantDto(UUID.fromString("b3c97f3f-dd2d-42d0-9032-954f361de632"), "testName", "testUrl", LocalDateTime.of(2020, 1, 2, 3, 4));
