...
public class ProductMapperTest {
    ...
    public void testFromDto_ReturnsEntity() {
        ProductDto dto = new ProductDto(1L, "testProduct", "testDescription", new CategoryDto(1L), null, null, List.of(new ProductMeasureValueDto(1L, new MeasureDto(1L, "abv", 1), new BigDecimal("100"))), "http://www.test.com", 1);
        Product product = productMapper.fromDto(dto);

        Product expectedProduct = new Product(1L, "testProduct", "testDescription", new ProductCategory(1L), List.of(new ProductMeasureValue(1L ,new Measure(1L, "abv", null, null, 1), new BigDecimal("100"), null)), "http://www.test.com", null, null, null, 1);
    ...
    public void testFromAddDto_ReturnsEntity() {
        AddProductDto dto = new AddProductDto("testProduct", "testDescription", 1L, List.of(new AddProductMeasureValueDto(1L, new BigDecimal("100"))), "http://www.test.com");
        Product product = productMapper.fromDto(dto);

        Product expectedProduct = new Product(null, "testProduct", "testDescription", new ProductCategory(1L), List.of(new ProductMeasureValue(null ,new Measure(1L), new BigDecimal("100"), null)), "http://www.test.com", null, null, null, null);
        expectedProduct.getTargetMeasures().get(0).setProduct(expectedProduct);
    ...
    public void testFromUpdateDto_ReturnsEntity() {
        UpdateProductDto dto = new UpdateProductDto("testProduct", "testDescription", 1L, List.of(new AddProductMeasureValueDto(1L, new BigDecimal("100"))), "http://www.test.com", 1);
        Product product = productMapper.fromDto(dto);

        Product expectedProduct = new Product(null, "testProduct", "testDescription", new ProductCategory(1L), List.of(new ProductMeasureValue(null, new Measure(1L), new BigDecimal("100"), null)), "http://www.test.com", null, null, null, 1);
        expectedProduct.getTargetMeasures().get(0).setProduct(expectedProduct);
    ...
    public void testToDto_ReturnsDto() {
        ...
        assertEquals(new ProductDto(1L, "testProduct", "testDescription", new CategoryDto(1L), null, null, List.of(new ProductMeasureValueDto(1L, new MeasureDto(1L, "abv", 1), new BigDecimal("100"))), "http://www.test.com", 1), dto);
    }
    ...
    public void testBeforeDto_setsAllCategories() {
        ...
        Product product = new Product(1L, "testProduct", "testDescription", subcategory2, List.of(new ProductMeasureValue(1L,new Measure(1L, "abv", LocalDateTime.of(2018, 1, 2, 3, 4), LocalDateTime.of(2019, 1, 2, 3, 4), 1), new BigDecimal("100"), new Product())), "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
