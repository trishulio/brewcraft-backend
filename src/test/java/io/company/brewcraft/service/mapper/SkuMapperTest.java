...
public class SkuMapperTest {
    ...
    public void testToDto_ReturnsDto() {
        Sku sku = new Sku(1L, new Product(2L), List.of(new SkuMaterial(3L)), Quantities.getQuantity(new BigDecimal("100"), SupportedUnits.HECTOLITRE), LocalDateTime.of(2018, 1, 2, 3, 4), LocalDateTime.of(2019, 1, 2, 3, 4), 1);

        SkuDto dto = skuMapper.toDto(sku);

        assertEquals(new SkuDto(1L, new ProductDto(2L), List.of(new SkuMaterialDto(3L)), new QuantityDto("hl", BigDecimal.valueOf(100)), 1), dto);
    }
