...
import io.company.brewcraft.service.TestBeans;
...
public class TenantServiceTest {
    ...
    public void init() {
        ...
        UpdateService<UUID, Tenant, BaseTenant, UpdateTenant> mUpdateService = TestBeans.updateService(BaseTenant.class, UpdateTenant.class, Tenant.class, Set.of("createdAt"));
