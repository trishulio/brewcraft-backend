...
public class EquipmentServiceImplTest {
    ...
    public void testGetAllEquipment_returnsEquipment() throws Exception {
        Equipment equipmentEntity = new Equipment(1L, new Facility(2L), "testName", EquipmentType.BARREL, EquipmentStatus.ACTIVE, Quantities.getQuantity("100 kg"), LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        ...
        assertEquals(equipmentEntity.getMaxCapacity(), actualEquipment.getMaxCapacity());
    ...
    public void testGetEquipment_returnsEquipment() throws Exception {
        ...
        assertEquals(expectedEquipmentEntity.get().getMaxCapacity(), returnedEntity.getMaxCapacity());
    ...
    public void testAddEquipment_Success() throws Exception {
        ...
        Equipment equipment = new Equipment(1L, new Facility(2L), "testName", EquipmentType.BARREL, EquipmentStatus.ACTIVE,  Quantities.getQuantity("100 kg"), LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        ...
        assertEquals(equipmentEntity.getMaxCapacity(), persistedEquipmentCaptor.getValue().getMaxCapacity());
        ...
        assertEquals(equipmentEntity.getMaxCapacity(), returnedEquipment.getMaxCapacity());
    ...
    public void testPutEquipment_success() throws Exception {
        ...
        Equipment putEquipment = new Equipment(1L, new Facility(2L), "testName", EquipmentType.BARREL, EquipmentStatus.ACTIVE,  Quantities.getQuantity("100 kg"), LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        Equipment equipmentEntity = new Equipment(1L, new Facility(2L), "testName", EquipmentType.BARREL, EquipmentStatus.ACTIVE,  Quantities.getQuantity("100 kg"), LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        ...
        assertEquals(putEquipment.getMaxCapacity(), persistedEquipmentCaptor.getValue().getMaxCapacity());
    ...
    public void testPatchEquipment_success() throws Exception {
        ...
        Equipment existingEquipmentEntity = new Equipment(1L, new Facility(2L), "testName", EquipmentType.BARREL, EquipmentStatus.ACTIVE,  Quantities.getQuantity("100 kg"), LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        Equipment persistedEquipmentEntity = new Equipment(1L, new Facility(2L), "updatedName", EquipmentType.BARREL, EquipmentStatus.ACTIVE,  Quantities.getQuantity("100 kg"), LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        ...
        assertEquals(existingEquipmentEntity.getMaxCapacity(), persistedEquipmentCaptor.getValue().getMaxCapacity());
        ...
        assertEquals(persistedEquipmentEntity.getMaxCapacity(), returnedEquipment.getMaxCapacity());
