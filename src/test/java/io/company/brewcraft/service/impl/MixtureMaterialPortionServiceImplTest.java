...
public class MixtureMaterialPortionServiceImplTest {
    ...
    public void testAddMaterialPortion_ThrowsWhenRequestedQuantityUnitIsNotCompatibleWithStockLotUnit() {
        ...
        doReturn(List.of(new StockLot(4L, null, Quantities.getQuantity(new BigDecimal("0"), SupportedUnits.GRAM), null, null, null, null))).when(stockLotService).getAllByIds(Set.of(4L));
    ...
    public void testAddMaterialPortion_ThrowsWhenQuantityIsUnavailable() {
        MixtureMaterialPortion materialPortion = new MixtureMaterialPortion(1L, new MaterialLot(4L), Quantities.getQuantity(new BigDecimal("100"), SupportedUnits.GRAM), new Mixture(5L), LocalDateTime.of(2018, 1, 2, 3, 4), LocalDateTime.of(2019, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
    ...
    public void testAddMaterialPortions_AddsMaterialPortions() {
        doReturn(List.of(new StockLot(4L, null, Quantities.getQuantity(new BigDecimal("200"), SupportedUnits.GRAM), null, null, null, null))).when(stockLotService).getAllByIds(any());
        doAnswer(mixtureMaterialPortion -> mixtureMaterialPortion.getArgument(0)).when(this.updateService).getAddEntities(any());

        final BaseMixtureMaterialPortion mixtureMaterialPortion1 = new MixtureMaterialPortion(1L, new MaterialLot(4L), Quantities.getQuantity(new BigDecimal("100"), SupportedUnits.GRAM), new Mixture(5L), LocalDateTime.of(2018, 1, 2, 3, 4), LocalDateTime.of(2019, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        ...
        final List<MixtureMaterialPortion> expected = List.of(
            new MixtureMaterialPortion(1L, new MaterialLot(4L), Quantities.getQuantity(new BigDecimal("100"), SupportedUnits.GRAM), new Mixture(5L), LocalDateTime.of(2018, 1, 2, 3, 4), LocalDateTime.of(2019, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1)
        );
    ...
    public void testPutMaterialPortions_ThrowsWhenMaterialPortionExistsAndQuantityIsUnavailable() {
        MixtureMaterialPortion existing = new MixtureMaterialPortion(1L, new MaterialLot(4L), Quantities.getQuantity(new BigDecimal("100"), SupportedUnits.GRAM), null, null, LocalDateTime.of(2019, 1, 2, 3, 4), null, 1);

        MixtureMaterialPortion update = new MixtureMaterialPortion(1L, new MaterialLot(4L), Quantities.getQuantity(new BigDecimal("200"), SupportedUnits.GRAM), new Mixture(5L), LocalDateTime.of(2018, 1, 2, 3, 4), LocalDateTime.of(2019, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
    ...
    public void testPutMaterialPortions_OverridesWhenMaterialPortionExists_SameLot() {
        ...
        doReturn(List.of(existing)).when(this.repoService).getByIds(List.of(update));
        doReturn(List.of(new StockLot(4L, null, Quantities.getQuantity(new BigDecimal("100"), SupportedUnits.GRAM), null, null, null, null))).when(stockLotService).getAllByIds(Set.of(4L));
        ...
        assertEquals(Quantities.getQuantity(new BigDecimal("200"), SupportedUnits.GRAM), materialPortion.getQuantity());
    ...
    public void testPutMaterialPortions_OverridesWhenMaterialPortionExists_DifferentLot() {
        ...
        MixtureMaterialPortion update = new MixtureMaterialPortion(1L, new MaterialLot(5L), Quantities.getQuantity(new BigDecimal("200"), SupportedUnits.GRAM), new Mixture(5L), LocalDateTime.of(2018, 1, 2, 3, 4), LocalDateTime.of(2019, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);

        doReturn(List.of(existing)).when(this.repoService).getByIds(List.of(update));
        doReturn(List.of(new StockLot(5L, null, Quantities.getQuantity(new BigDecimal("200"), SupportedUnits.GRAM), null, null, null, null))).when(stockLotService).getAllByIds(Set.of(5L));
        doAnswer(inv -> inv.getArgument(1)).when(this.updateService).getPutEntities(any(), any());
    ...
    public void testPutMaterialPortions_AddsNewMaterialPortion_WhenNoMaterialPortionExists() {
        MixtureMaterialPortion update = new MixtureMaterialPortion(1L, new MaterialLot(4L), Quantities.getQuantity(new BigDecimal("100"), SupportedUnits.GRAM), new Mixture(5L), LocalDateTime.of(2018, 1, 2, 3, 4), LocalDateTime.of(2019, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);

        doReturn(List.of()).when(this.repoService).getByIds(List.of(update));
        doReturn(List.of(new StockLot(4L, null, Quantities.getQuantity(new BigDecimal("200"), SupportedUnits.GRAM), null, null, null, null))).when(stockLotService).getAllByIds(Set.of(4L));
        doAnswer(inv -> inv.getArgument(1)).when(this.updateService).getPutEntities(any(), any());
