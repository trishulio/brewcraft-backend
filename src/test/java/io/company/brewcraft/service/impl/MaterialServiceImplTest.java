...
public class MaterialServiceImplTest {
    ...
    public void testGetMaterials_returnsMaterials() throws Exception {
        Material materialEntity = new Material(1L, "testMaterial", "testDescription", new MaterialCategory(1L), "testUPC", SupportedUnits.GRAM, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
    ...
    public void testAddMaterial_SavesMaterial() throws Exception {
        Material material = new Material(1L, "testMaterial", "testDescription", new MaterialCategory(1L), null, SupportedUnits.GRAM, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);

        Material newMaterial = new Material(1L, "testMaterial", "testDescription", new MaterialCategory(1L), "testUPC", SupportedUnits.GRAM, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
    ...
    public void testPutMaterial_success() throws Exception {
        Long id = 1L;
        Material putMaterial = new Material(1L, "testMaterial", "testDescription", new MaterialCategory(1L), null, SupportedUnits.GRAM, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        Material materialEntity = new Material(1L, "testMaterial", "testDescription", new MaterialCategory(1L), "testUPC", SupportedUnits.GRAM, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
    ...
    public void testPatchMaterial_success() throws Exception {
        ...
        Material existingMaterialEntity = new Material(1L, "materialName", "testDescription", new MaterialCategory(1L), "testUPC", SupportedUnits.GRAM, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
        Material persistedMaterialEntity = new Material(1L, "updatedName", "testDescription", new MaterialCategory(1L), "testUPC", SupportedUnits.GRAM, "http://www.test.com", LocalDateTime.of(2020, 1, 2, 3, 4), LocalDateTime.of(2020, 1, 2, 3, 4), 1);
