...
public class MaterialLotDtoTest {
    ...
    public void testAllArgConstructor() {
        dto = new MaterialLotDto(1L, "LOT_1", new QuantityDto("kg", new BigDecimal("10.00")), new MaterialDto(100L), new InvoiceItemDto(200L), new StorageDto(300L), LocalDateTime.of(1999, 1, 1, 0, 0), LocalDateTime.of(2000, 1, 1, 0, 0), 1);

        assertEquals(1L, dto.getId());
        assertEquals("LOT_1", dto.getLotNumber());
        assertEquals(new QuantityDto("kg", new BigDecimal("10.00")), dto.getQuantity());
        assertEquals(new MaterialDto(100L), dto.getMaterial());
