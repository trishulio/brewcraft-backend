...
public class MixtureMaterialPortionDtoTest {
    ...
    public void testConstructor() {
        ...
        assertEquals(new QuantityDto("g", new BigDecimal("100")), mixtureMaterialPortionDto.getQuantity());
    ...
    public void testGetSetQuantity() {
        mixtureMaterialPortionDto.setQuantity(new QuantityDto("g", new BigDecimal("100")));
        assertEquals(new QuantityDto("g", new BigDecimal("100")), mixtureMaterialPortionDto.getQuantity());
    }
