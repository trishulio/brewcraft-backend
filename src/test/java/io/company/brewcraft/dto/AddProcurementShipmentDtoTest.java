...
public class AddProcurementShipmentDtoTest {
    private AddProcurementShipmentDto dto;

    @BeforeEach
    public void init() {
        dto = new AddProcurementShipmentDto();
    }

    @Test
    public void testAllArgConstructor_SetsAllFieldValues() {
        List<AddMaterialLotDto> lots = List.of(new AddMaterialLotDto());
        dto = new AddProcurementShipmentDto("SHIPMENT_1", "DESCRIPTION_1", 99L, LocalDateTime.of(1999, 1, 1, 0, 0), LocalDateTime.of(2000, 1, 1, 0, 0));
