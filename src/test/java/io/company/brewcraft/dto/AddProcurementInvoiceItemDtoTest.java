...
public class AddProcurementInvoiceItemDtoTest {
    ...
    public void testAllArgs() {
        invoiceItem = new AddProcurementInvoiceItemDto("desc2", new QuantityDto("g", new BigDecimal("4")), new MoneyDto("CAD", new BigDecimal("5")), new TaxDto(new TaxRateDto(new BigDecimal("6"))), 7L);
