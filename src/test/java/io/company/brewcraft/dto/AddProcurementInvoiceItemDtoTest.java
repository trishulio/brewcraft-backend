...
public class AddProcurementInvoiceItemDtoTest {
    ...
    public void testAllArgs() {
        invoiceItem = new AddProcurementInvoiceItemDto("desc2", new QuantityDto("kg", new BigDecimal("4")), new MoneyDto("CAD", new BigDecimal("5")), new TaxDto(new MoneyDto("CAD", new BigDecimal("6"))), 7L);
