...
public class UpdateSupplierContactDtoTest {
    private UpdateSupplierContactDto updateSupplierContactDto;

    @BeforeEach
    public void init() {
        updateSupplierContactDto = new UpdateSupplierContactDto();
    }
