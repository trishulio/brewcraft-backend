...
public class EnhancedInvoiceRepositoryImplTest {
    ...
    public void init() {
        ...
        itemRepo = mock(InvoiceItemRepository.class);

        repo = new EnhancedInvoiceRepositoryImpl(itemRepo, mStatusRepo, mPoRepo);
    }
    ...
    public void testRefresh_PerformsRefreshOnChildEntities() {
        ...
        List<InvoiceItem> items = List.of(new InvoiceItem(10L), new InvoiceItem(20L), new InvoiceItem(30L));

        invoices.get(0).setItems(List.of(items.get(0)));
        invoices.get(1).setItems(List.of(items.get(1)));
        invoices.get(2).setItems(List.of(items.get(2)));
        ...
        verify(itemRepo, times(1)).refresh(items);
    }
